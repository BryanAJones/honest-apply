...
> Leave the **Platform Plan** (template §8) and the publishable Profile Pack copy as
> `[generated by job-application-profile]` placeholders — they're produced by that step, not here.
...
1. Render `career-profile.md` using the structure in `references/PROFILE-TEMPLATE.md` from
   ...
   - **Freelance / both:** the shared sections PLUS Freelance Track Sections 4-7 (Freelance
     Targeting Spec, Profile Pack source, Proof Ledger, Proposal Spine). Leave §8 Platform Plan
     and the publishable Profile Pack copy as `[generated by job-application-profile]`.
